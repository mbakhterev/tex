...
% Генерация команд для различных операторов. Использование примерно такое:
% \opscheme{\product}{\prod}{\times}{\identity}{\identity} последнй параметр --
% это обёртка для выражения. Для \DSum, например, необходимо добавить ()⊥.
% Параметра два, чтобы иметь возможность поставить большие скобки

\newcommand\opscheme[5]{%
...
\opscheme{\product}{\prod}{\times}{\identity}{\identity}
\mopscheme{\mproduct}{\prod}{\times}{\identity}{\identity}
...
\opscheme{\oneof}{\sum}{+}{\pars}{\Pars}
\mopscheme{\moneof}{\sum}{+}{\pars}{\Pars}
