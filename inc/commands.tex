...
\providecommand\grk[1]{\foreignlanguage{greek}{#1}}
\providecommand\eng[1]{\foreignlanguage{english}{#1}}

\providecommand\range[2]{\enumr{#1}{#2}}

\providecommand\lx[1]{{\grk{l}-#1}}
\providecommand\px[1]{{\grk{p}-#1}}
...
\providecommand\mpi[1]{\codepair{MPI}{#1}}
\providecommand\ride[1]{\codepair{RiDE}{#1}}
\providecommand\hadoop[1]{\codepair{Hadoop}{#1}}

\providecommand\mr[1]{\ensuremath{\mathtt{R}_\mathtt{#1}}}

\providecommand\rfive[0]{\mr{5}}
\providecommand\rsix[0]{\mr{6}}
